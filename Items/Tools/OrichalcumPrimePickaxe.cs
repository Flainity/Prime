...
{
    public class OrichalcumPrimePickaxe : ModItem
    {
        public override void SetDefaults()
        {
            item.CloneDefaults(ItemID.OrichalcumPickaxe);
            item.useTime = 2;
            item.axe = 55;
        ...
        public override void AddRecipes()
        {
            ...
            recipe01.AddIngredient(ItemID.OrichalcumBar, 18);
            ...
            recipe02.AddIngredient(ItemID.OrichalcumBar, 18);
